...
async def send_email(email: EmailStr, username: str, host: str):
    ...
    :param host: str: Pass the host to the email template
    :return: A coroutine, which is a special type of object that works with the asyncio module
    :doc-author: Trelent
    """
    try:
